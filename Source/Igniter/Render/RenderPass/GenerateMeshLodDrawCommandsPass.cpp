...
namespace ig
{
    ...
    void GenerateMeshLodDrawCommandsPass::PreRender(const LocalFrameIndex localFrameIdx)
    {
    ...
    void GenerateMeshLodDrawCommandsPass::Render(const LocalFrameIndex localFrameIdx)
    {
        ZoneScoped;
