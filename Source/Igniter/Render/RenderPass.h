...
namespace ig
{
    ...
    public:
        ...
        virtual void Execute(const ig::LocalFrameIndex localFrameIdx) final;

    protected:
        virtual void PreRender([[maybe_unused]] const ig::LocalFrameIndex localFrameIdx) {}
        virtual void Render(const ig::LocalFrameIndex localFrameIdx) = 0;
        virtual void PostRender([[maybe_unused]] const ig::LocalFrameIndex localFrameIdx) {}

        virtual void ExecuteWhenInactive([[maybe_unused]] const ig::LocalFrameIndex localFrameIdx) {}
