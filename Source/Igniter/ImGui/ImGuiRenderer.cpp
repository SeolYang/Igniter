...
namespace ig
{
    ...
    void ImGuiRenderer::SetupDefaultTheme()
    {
        ...
        style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.6196078658103943f, 0.6196078658103943f, 0.6196078658103943f,
                                                     1.0f);
        ...
        style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.08235294371843338f, 0.08235294371843338f, 0.08235294371843338f,
                                                      1.0f);
        style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.08235294371843338f, 0.08235294371843338f,
                                                         0.08235294371843338f, 1.0f);
        style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.08235294371843338f, 0.08235294371843338f, 0.08235294371843338f,
                                                  1.0f);
        style.Colors[ImGuiCol_ScrollbarBg] =
                ImVec4(0.1019607856869698f, 0.1019607856869698f, 0.1019607856869698f, 1.0f);
        style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.3411764800548553f, 0.3411764800548553f, 0.3411764800548553f,
                                                      1.0f);
        style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.501960813999176f, 0.501960813999176f, 0.501960813999176f,
                                                             1.0f);
        style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.501960813999176f, 0.501960813999176f, 0.501960813999176f,
                                                            1.0f);
        ...
        style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.3411764800548553f, 0.3411764800548553f, 0.3411764800548553f,
                                                      1.0f);
        ...
        style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.1843137294054031f, 0.1843137294054031f, 0.1843137294054031f,
                                                      1.0f);
        style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.0f, 0.4392156898975372f, 0.8784313797950745f, 1.0f);
        style.Colors[ImGuiCol_Separator]    = ImVec4(0.4274509847164154f, 0.4274509847164154f, 0.4980392158031464f,
                                                     0.8235294222831726f);
        style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.09803921729326248f, 0.4000000059604645f, 0.7490196228027344f,
                                                         0.7799999713897705f);
        style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.3532207012176514f, 0.5698376893997192f, 0.8068669438362122f,
                                                        1.0f);
        style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.08235294371843338f, 0.08235294371843338f, 0.08235294371843338f,
                                                   1.0f);
        ...
        style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.1294117718935013f, 0.1294117718935013f, 0.1294117718935013f,
                                                     1.0f);
        style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.1294117718935013f, 0.1294117718935013f,
                                                           0.1294117718935013f, 1.0f);
        style.Colors[ImGuiCol_PlotLines] = ImVec4(0.6078431606292725f, 0.6078431606292725f, 0.6078431606292725f, 1.0f);
        style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.0f, 0.4274509847164154f, 0.3490196168422699f, 1.0f);
        style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.8980392217636108f, 0.6980392336845398f, 0.0f, 1.0f);
        style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.0f, 0.6000000238418579f, 0.0f, 1.0f);
        style.Colors[ImGuiCol_TableHeaderBg] = ImVec4(0.1843137294054031f, 0.1843137294054031f, 0.1843137294054031f,
                                                      1.0f);
        style.Colors[ImGuiCol_TableBorderStrong] = ImVec4(0.1215686276555061f, 0.1215686276555061f, 0.1215686276555061f,
                                                          1.0f);
        style.Colors[ImGuiCol_TableBorderLight] = ImVec4(1.0f, 1.0f, 1.0f, 0.105882354080677f);
        style.Colors[ImGuiCol_TableRowBg] = ImVec4(0.08235294371843338f, 0.08235294371843338f, 0.08235294371843338f,
                                                   1.0f);
        style.Colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.1019607856869698f, 0.1019607856869698f, 0.1019607856869698f,
                                                      1.0f);
