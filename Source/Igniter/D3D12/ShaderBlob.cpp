...
namespace ig
{
        ...
        : type(desc.Type)
    {
        ...
        IG_VERIFY_SUCCEEDED(
            compiler->Compile(&buffer, arguments.data(), static_cast<uint32_t>(arguments.size()), defaultIncludeHandler.
                Get(),
        ...
        {
            IG_LOG(ShaderBlob, Fatal, "Failed to compile shader {}; {}", desc.SourcePath.ToStringView(),
