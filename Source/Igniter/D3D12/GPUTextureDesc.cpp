...
namespace ig
{
    ...
    {
        IG_VERIFY(
            desc.Dimension != D3D12_RESOURCE_DIMENSION_BUFFER && desc.Dimension != D3D12_RESOURCE_DIMENSION_UNKNOWN);
    ...
    std::vector<D3D12_SUBRESOURCE_DATA> GpuTextureDesc::GenerateSubresourcesData(
        const std::span<uint8_t> memoryBlock) const
    {
