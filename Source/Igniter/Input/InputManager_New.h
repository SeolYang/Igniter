...
namespace ig
{
    ...
    public:
        InputManager_New();
        InputManager_New(const InputManager_New&)     = delete;
        InputManager_New(InputManager_New&&) noexcept = delete;
        ~InputManager_New();

        InputManager_New& operator=(const InputManager_New&)     = delete;
        InputManager_New& operator=(InputManager_New&&) noexcept = delete;
